...
<?php
    ...
    $ketqua2=mysqli_query($link,$query3);
     ...
     $query4="SELECT * FROM loaitin where maloai=$a";
     $ketqua4=mysqli_query($link,$query4);
     $hang4=mysqli_fetch_assoc($ketqua4);

     
     $query5="SELECT matin,anh,tieude,motatin FROM tintuc WHERE maloai=$a ORDER BY matin DESC LIMIT 5";
...
<div class="row">
    ...
    <center>
    <hr style="width:30%;color:red;height:10px;border-radius: 15px;">

		<h2 class="list-product-title"><?php echo $hang4['tenloai'] ?></h2>
		<div class="list-product-subtitle">
			<p>Tin Tức Về <?php echo $hang4['tenloai'] ?> </p>
       ...
       <?php do{ ?>
          <div class="row" style="margin-left:0px;margin-right:0px" >
                ...
                <div class="col-md-10  col-12" >
					    ...
					    <h5 class="card-title" style="height:30px;font-size: 19px;"><a a class="ten" href="noidung.php?matin=<?php echo $hang5['matin']?>"><?php echo $hang5['tieude']?></a></h5>
					    <p class="card-text" style="height:70px"><?php echo $hang5['motatin']."...."?></p>
...
<h4 class="content">Tin Tức Liên Quan</h4>
                <ul class="menu" style="list-style:none">
				<?php 
						
						$link = mysqli_connect ('localhost', 'root', '', 'quanlytintuc2') or die ("Ko the ket noi Database");
						$sql = "SELECT * FROM tintuc where maloai not in ($a) group by matin desc limit 8 ";;
...
<div class="noidung2"> 
<div class="row" >
<?php $sql1="SELECT*FROM tintuc WHERE maloai=$a and matin not in(SELECT matin FROM(SELECT matin FROM tintuc WHERE maloai=$a ORDER BY matin DESC Limit 5)tintuc) ORDER BY matin DESC;";
       ...
       <div class="row" style="margin-left:0px;margin-right:0px" >
            ...
            <div class="col-md-3  col-12" style="padding-left:9px;padding-right:9px">
    
              
                <img   class="card-img-top" src="asset/css/img/<?php echo $detail1['anh']?> " alt="Card image cap" style="height:90px; width:140px" >
                
              
            </div>
                    <div class="col-md-9  col-12" style="padding-left:0px;padding-right:0px" >
    
            
                
                
                  <h5 class="card-title" style="height:30px;font-size: 19px;"><a a class="ten" href="noidung.php?matin=<?php echo $detail1['matin']?>"><?php echo $detail1['tieude']?></a></h5>
                  <p class="card-text" style="height:70px"><?php echo $detail1['motatin']."...."?></p>
